        ...
        this.nps = {
                    ...
                    if(window == window.top){
                        ...
                        if(!this.loadingpane){
                            ...
                            $(window).resize(function(){
                                nps.loadingpane.css({"width":$(".content").width(),"height":$(".content").outerHeight()});
                            });
                        }
                        ...
                        //init action buttons
                        var co;
                        $("dd.menu-control > a, div.block-system").on("mouseenter", function(e){
                            e.stopPropagation();
                            clearTimeout(co);
                            $("div.block-system").stop(true,true).fadeIn(300);
                        });

                        $("dd.menu-control > a, div.block-system").on("mouseleave", function(e){
                            co = setTimeout(function(){
                                $("div.block-system").stop(true,true).fadeOut(100);
                                }, 500);
                        });

                        $("dd.menu-control > a").on("click", function(){
                            //refresh iframe
                        ...
                        $("div.block-system div").on("click", function(){
                            if($(this).is(":has(span.icon-info)")){
                                nps.info();
                            }
                        });
            ...
            info: function(title, content){
                if(window == window.top){
                    if(nps.infoblock){
                        if(title){
                            nps.infoblock.find("h5").html(title);
            ...
            openInFrame: function(url){
                if(window == window.top){
                    ...
                    if(this.loadingpane){
                        ...
                        this.loadingpane.css({"width":$(".content").width(),"height":$(".content").outerHeight()});
    ...
    var menu = {
        ...
        refresh: function(items){
            ...
            $("dd > a, ul", this.element).mouseenter(function(e){
                ...
                if($(this).is("dd > a")){
                    $("ul", _this.element).stop(true,true).fadeOut(100);
                    $(this).siblings("ul").stop(true,true).fadeIn(300);
                }
            });
            ...
            $("ul li a", this.element).hover(
                function(){
                    ...
                    $("ul li ul", _this.element).stop(true,true).hide();
                    $(this).siblings("ul").stop(true,true).fadeIn(300);
