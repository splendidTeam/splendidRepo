 ...
 */
package com.baozun.nebula.utils.security.symmetric;
...
import com.baozun.nebula.utils.security.ByteUtil;
 ...
 * 		LOGGER.info(symmetricEncryption.encryptHex(original,CharsetType.UTF8));
 * 		
 ...
 * 
 * 		SymmetricEncryption symmetricEncryption = new SymmetricEncryption(SymmetricType.Blowfish, keyString);
 * 		LOGGER.info(symmetricEncryption.decryptHex(hexString,CharsetType.UTF8));
 * 
 * 		输出:鑫哥爱feilong
 * }
 * </pre>
...
public final class SymmetricEncryption{
    ...
    /** The Constant LOGGER. */
    protected static final Logger LOGGER = LoggerFactory.getLogger(SymmetricEncryption.class);
     ...
     * @see org.apache.commons.codec.binary.Base64
     * @see com.feilong.core.lang.CharsetType
     */
    ...
    public String encryptBase64(String original,String charsetName) throws EncryptionException{
        try{
            ...
            if (LOGGER.isErrorEnabled()){
                ...
                LOGGER.error(JsonUtil.format(map));
            }
            LOGGER.error(e.getClass().getName(), e);
    ...
    public String encryptHex(Object original,String charsetName) throws EncryptionException{
        try{
            byte[] bs = StringUtil.getBytes(original.toString(), charsetName);
    ...
    private Key getKey(String _keyString) throws NoSuchAlgorithmException{
        ...
        //keyGenerator.init(16,secureRandom);
