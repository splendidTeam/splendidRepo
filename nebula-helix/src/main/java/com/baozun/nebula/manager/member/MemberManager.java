...
public interface MemberManager extends BaseManager {
	 ...
	 * @return
	 */
	public Long login(MemberFrontendCommand memberCommand,List<ShoppingCartLineCommand> shoppingLines)throws LoginException ;
	/**
	 * 包含用户名、手机、邮箱
	 * @param loginName
	 * @return
	 ...
	 * @return
	 */
	public Member register(MemberFrontendCommand memberCommand,List<ShoppingCartLineCommand> shoppingLines);
