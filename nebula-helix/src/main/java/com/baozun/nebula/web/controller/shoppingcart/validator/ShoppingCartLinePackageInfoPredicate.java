...
public class ShoppingCartLinePackageInfoPredicate implements Predicate<List<ShoppingCartLinePackageInfoCommand>>{
     ...
     */
    public ShoppingCartLinePackageInfoPredicate(List<PackageInfoForm> packageInfoFormList){
        super();
    ...
    public boolean evaluate(List<ShoppingCartLinePackageInfoCommand> shoppingCartLinePackageInfoCommandList){
        ...
        for (PackageInfoForm packageInfoForm : packageInfoFormList){
            Predicate<ShoppingCartLinePackageInfoCommand> equalPredicate = BeanPredicateUtil.equalPredicate(toMap("type", packageInfoForm.getType(), "featureInfo", packageInfoForm.getFeatureInfo()));
