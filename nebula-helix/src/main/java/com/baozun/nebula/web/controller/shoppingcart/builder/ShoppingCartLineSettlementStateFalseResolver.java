 ...
 * @since 5.3.2.14
 */
public class ShoppingCartLineSettlementStateFalseResolver implements ShoppingCartLineSettlementStateResolver{

    private static final Logger LOGGER = LoggerFactory.getLogger(ShoppingCartLineSettlementStateFalseResolver.class);
