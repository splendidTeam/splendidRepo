...
public class ModuleTag extends TagSupport{
     ...
     * 启用0.5分钟缓存
     */
    private GuavaAbstractLoadingCache<String, Optional<Map<String, List<CmsModuleInstanceVersionCommand>>>> cache = new GuavaAbstractLoadingCache<String, Optional<Map<String, List<CmsModuleInstanceVersionCommand>>>>(100, 30){
