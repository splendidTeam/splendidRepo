 ...
 * @since 5.3.2.20
 */
public class ShoppingcartBatchResult implements Serializable{
    ...
    /** 如果有失败的,那么这里将返回 对应的sku id 和 原因; 成功的话 这里将是 null. */
     ...
     * 
     */
    public ShoppingcartBatchResult(){
        super();
    }
     ...
     */
    public ShoppingcartBatchResult(boolean isSuccess, Map<Long, ShoppingcartResult> skuIdAndShoppingcartResultFailMap){
        super();
    ...
    /**
     * 获得 如果有失败的,那么这里将返回 对应的sku id 和 原因; 成功的话 这里将是 null.
     *
    ...
    /**
     * 设置 如果有失败的,那么这里将返回 对应的sku id 和 原因; 成功的话 这里将是 null.
     *
     * @param skuIdAndShoppingcartResultFailMap
