 ...
 */
public interface ShoppingcartAddDetermineSameLineElementsBuilder{

    ShoppingcartAddDetermineSameLineElements build(ShoppingCartLineAddForm shoppingCartLineAddForm);
}
