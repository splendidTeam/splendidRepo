 ...
 *
 */
package com.baozun.shopdog.web.controller;
...
/**  
 * ShopDog基础转换器，所有ViewCommand的转换器的基类。
 ...
 * @Description 
 * @author dongliang ma
 * @date 2016年5月11日 下午4:40:07 
 * @version   
 */
public abstract class ShopdogBaseConverter <T extends ShopdogBaseCommand> implements Serializable{
	/**
	 * 
	 */
