...
public class NavigationCommand implements Command{
	...
	private List<FacetParameter>	facetParameterList;
	 ...
	 * 扩展字段
	 */
	private LangProperty			extention;
	...
	public LangProperty getExtention(){
		return extention;
	}

	public void setExtention(LangProperty extention){
		this.extention = extention;
	}

	
	public List<FacetParameter> getFacetParameterList(){
		return facetParameterList;
	}

	
	public void setFacetParameterList(List<FacetParameter> facetParameterList){
		this.facetParameterList = facetParameterList;
	}
