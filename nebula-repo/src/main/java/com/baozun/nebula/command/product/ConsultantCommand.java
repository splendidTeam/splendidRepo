...
public class ConsultantCommand implements Command {
	...
	private static final long serialVersionUID = 6146317111690801800L;
	...
	/**
	 * @param consultype the consultype to set
	 */
	...
	/**
	 * @param publishMark the publishMark to set
	 */
	...
	/**
	 * @param resolveNote the resolveNote to set
	 */
	...
	/**
	 * @param resolveId the resolveId to set
	 */
	...
	/**
	 * @param resolveTime the resolveTime to set
	 */
	...
	/**
	 * @param unPublishId the unPublishId to set
	 */
	...
	/**
	 * @param unPublishTime the unPublishTime to set
	 */
