 ...
 * @author lujun
 */
public class ItemSolrCommand extends BaseItemForSolrCommand {
...
//	private String spread;
	 ...
	 * 动态属性(筛选色  颜色对照)
	 */
	private Map<String,List<String>> dynamicColorRef;
...
//	}
	...
	public Map<String, List<String>> getDynamicColorRef() {
		return dynamicColorRef;
	}

	public void setDynamicColorRef(Map<String, List<String>> dynamicColorRef) {
		this.dynamicColorRef = dynamicColorRef;
	}
