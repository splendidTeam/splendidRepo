...
public class SdkItemVisibilityManagerImpl implements SdkItemVisibilityManager{
    ...
    @Override
    @Transactional(readOnly = true)
    public List<ItemVisibility> findItemVisibilityListByItemFilterIds(List<String> itemFilterIds){
    ...
    public Set<Long> getMembersByItemId(Long itemId){
        ...
        //根据商品id查询商品筛选器
        Set<String> itemFilterIds = sdkEngineManager.getItemScopeListByItemAndCategory(itemId, null);
