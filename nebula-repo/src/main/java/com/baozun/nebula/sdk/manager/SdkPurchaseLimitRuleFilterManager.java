...
public interface SdkPurchaseLimitRuleFilterManager extends BaseManager{
	 ...
	 * @return
	 */
	public List<LimitCommand> getPurchaseLimitItemScopePromotionData(
			List<Long> shopIds,Set<String> itemComboIds);
	 ...
	 * @return
	 */
	public List<LimitCommand> getIntersectPurchaseLimitRuleData(
