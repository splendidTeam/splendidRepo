...
public class SdkPaymentManagerImpl implements SdkPaymentManager {
	...
	@Override
	public void savePaymentLog(Date createTime, String message, String operator,
			String returnVal) {
		paymentLogDao.savePaymentLog(createTime, message, operator, returnVal);
	}

	@Override
	public void upPayInfoCallCloseStaBySubOrdinate(Long orderId,
			Boolean callCloseStatus, Date modifyTime) {
	...
	public String savePayCodeInfo(List<SalesOrderCommand> sos) {
		String subOrdinate = creator.createOrderCode();
	...
	private OrderCodeCreatorManager getOrderCodeCreator() {
		...
		try {
			...
			Class<OrderCodeCreatorManager> cls = (Class<OrderCodeCreatorManager>) Class
					.forName(className);
	...
	@Override
	public void updatePayCodePayStatus(String subinateCode, Date modifyTime,
	...
	@Override
	@Transactional(readOnly=true)
	public PayCode findPayCodeByCodeAndPayTypeAndPayStatus(String code,
			Integer payType, boolean flag) {
