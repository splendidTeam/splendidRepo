...
public interface SdkShoppingCartManager extends BaseManager{
	...
	public ShoppingCartCommand findShoppingCart(Long userId, Set<String> memComIds, List<String> coupons,
			CalcFreightCommand calcFreightCommand, List<ShoppingCartLineCommand> lines);
	/**
	 * 获取当前人员的选择的赠品行
	 * @param memberId
	 * @param callType
	 ...
	 * 		请参照addOrUpdateShoppingCart(Long memberId, Long lineId, List<ShoppingCartLineCommand> lines, Set<String> memComboIds, boolean exist, boolean isReduce)
	 * 
	 */
	 ...
	 * @return
	 */
	Integer addOrUpdateShoppingCartById(Long memberId, String extentionCode, List<ShoppingCartLineCommand> lines,
	 ...
	 * @param lines
	 */
	Integer immediatelyBuy(Long memberId, Set<String> memCombos, ShoppingCartLineCommand shoppingCartLine,
	...
	public boolean checkCouponByCustomItemIds(List<ShoppingCartLineCommand> shoppingCartLines, List<Long> itemIdList,
			long couponTypeID, List<PromotionCouponCodeCommand> couponCodes, long shopId);
	...
	public Map<String, BigDecimal> getDiscountAMTByCALLCoupon(List<ShoppingCartLineCommand> shoppingCartLines,
			long couponTypeId, List<PromotionCouponCodeCommand> coupons, boolean onePieceMark, long shopId,
			BigDecimal previousDiscAMTAll);
	...
	public List<PromotionSKUDiscAMTBySetting> getSinglePrdDiscountAMTCustomPerItemByRate(List<ShoppingCartLineCommand> lines, long customId, BigDecimal discRate, boolean onePieceMark,
			Integer factorDefault, List<ItemFactor> itemFactorList, List<PromotionBrief> briefListPrevious);
	
	public List<PromotionSKUDiscAMTBySetting> getSinglePrdDiscountAMTCustomPerPCSByAMT(
			List<ShoppingCartLineCommand> lines, long customId, BigDecimal discAmount, Integer factorDefault,
			List<ItemFactor> itemFactorList, List<PromotionBrief> briefListPrevious);
	
	public List<PromotionSKUDiscAMTBySetting> getSinglePrdDiscountAMTCustomPerPCSByRate(
			List<ShoppingCartLineCommand> lines, long customId, BigDecimal discRate, boolean onePieceMark,
			Integer factorDefault, List<ItemFactor> itemFactorList, List<PromotionBrief> briefListPrevious);
