...
public enum EmailType{
    ...
    /**
     * "baozun邮箱","http://mail.baozun.cn/","baozun.cn"
     */
    emailBaozumail("baozun邮箱","http://mail.baozun.cn/","baozun.cn"),

    /**
     * "baozun邮箱","http://mail.baozun.com/","baozun.com"
     */
    BAOZUN_COM("baozun邮箱","http://mail.baozun.com/","baozun.com");
    ...
    // 构造函数，枚举类型只能为私有
    private EmailType(Integer type){
        this.type = type;
    }
