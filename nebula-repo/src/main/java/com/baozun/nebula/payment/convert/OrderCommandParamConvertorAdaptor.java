...
public class OrderCommandParamConvertorAdaptor implements PayParamCommandAdaptor {
	...
	public String getCustomerIp() {
		if(Validator.isNotNullOrEmpty(getSalesOrderCommand().getOnLinePaymentCommand()) && StringUtils.isNotEmpty(getSalesOrderCommand().getOnLinePaymentCommand().getCustomerIp()))
			return salesOrderCommand.getOnLinePaymentCommand().getCustomerIp();
		else if(Validator.isNotNullOrEmpty(getRequestParams().get("customerIp")))
