...
public abstract class AbstractCacheBuilder<T, EX extends Exception> {
    ...
    public T getCachedObject() throws EX{
        ...
        try{
            ...
            LOG.error("get cache exception. exception:{} [{}] \"{}\"", e.getMessage(), new Date(), this.getClass().getSimpleName());
        ...
        if (t == null){
            ...
            try{
                ...
                LOG.error("set cache exception. exception:{} [{}] \"{}\"", e.getMessage(), new Date(), this.getClass().getSimpleName());
                LOG.error("cache exception.", e);
            }
        }
