...
public class PayWarnningEvent extends AbstractPaymentEvent{
    ...
    public PayWarnningEvent(Object source, String orderCode, String thirPayNo, Date createTime, String paystate_shop, String paystate_payment, Boolean isSupportQuery, String result){
        super(source);
