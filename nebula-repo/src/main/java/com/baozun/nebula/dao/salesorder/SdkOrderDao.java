...
public interface SdkOrderDao extends GenericEntityDao<SalesOrder, Long>{
     ...
     */
    @NativeQuery(model = SalesOrderCommand.class)
    List<SalesOrderCommand> findOrderByExntentionListAndOrderCreateTime(@QueryParam("extentionList") List<String> extentionList,@QueryParam("startTime") Date startTime);
     ...
     */
    @NativeQuery(model = SalesOrderCommand.class)
    List<SalesOrderCommand> findOrderByExntentionListAndOrderStatus(@QueryParam("extentionList") List<String> extentionList,@QueryParam("orderStatus") List<Integer> orderStatus);
     ...
     */
    @NativeUpdate
    Integer updateOrderPaymentTypeByOrderCode(@QueryParam("code") String code,@QueryParam("payment") Integer payment);
     ...
     */
    @NativeUpdate
    Integer updateOrderPaymentTypeByOrderId(@QueryParam("id") Long id,@QueryParam("payment") Integer payment);
    ...
    void updateLogisticsInfo(
                    ...
                    @QueryParam("actualFreight") BigDecimal actualFreight,
