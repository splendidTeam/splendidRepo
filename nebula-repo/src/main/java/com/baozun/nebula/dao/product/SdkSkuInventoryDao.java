...
public interface SdkSkuInventoryDao extends GenericEntityDao<SkuInventory, Long>{
     ...
     */
    @NativeUpdate
    Integer liquidateSkuInventory(@QueryParam("extentionCode") String extentionCode,@QueryParam("count") Integer count);
     ...
     */
    @NativeUpdate
    Integer addSkuInventory(@QueryParam("extentionCode") String extentionCode,@QueryParam("count") Integer count);
     ...
     */
    @NativeUpdate
    void insertSkuInventory(SkuInventory skuInventory);
