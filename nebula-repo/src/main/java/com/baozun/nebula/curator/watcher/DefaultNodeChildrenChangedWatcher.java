 ...
 * 该默认实现总是会不断地循环监听指定路径的NodeChildrenChanged事件，即{@link IWatcher#needContinueWatch()}方法永远返回true。
 * </p>
 * 
 * <h3>默认的参数如下：</h3>
 * <ol>
 ...
 */
public class DefaultNodeChildrenChangedWatcher extends AbstractWatcher {
