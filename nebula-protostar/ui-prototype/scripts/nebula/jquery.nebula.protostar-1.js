(function($){
    ...
    if(typeof this["nps"] === "undefined"){
        this.nps = {
                    ...
                    if(window == window.top){
                        ...
                        if(!this.infoblock){
                            ...
                            $(".cross, .button-cancel", this.confirmblock).click(function(){
                            	if(nps.confirmblock.data("cancelf")!=undefined){
                            		loxia.hitch(nps.confirmblock.data("cancelf"))();
                            	}
            ...
            confirm: function(title, content, success,cancelf){
                if(window == window.top){
                    if(nps.confirmblock){
                        if(title){
                            ...
                            nps.confirmblock.stop(true,true).slideDown({
                                ...
                                complete: function(){
                                    ...
                                    nps.confirmblock.data("cancelf",cancelf);
                                }
                            });
                        }
                    }
                }else{
                    loxia.hitch(window.parent.nps,"confirm")(title,content,success,cancelf);
                }
            },
