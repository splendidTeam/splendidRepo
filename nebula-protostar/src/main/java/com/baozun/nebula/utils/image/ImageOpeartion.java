...
public class ImageOpeartion {
     ...
     *            :生成图片的高度  
     */  
	public static void reduceImgCut(File srcfile, String imgdist, int widthdist,   
            int heightdist) {   
        try {   
            if (!srcfile.exists()) {   
                return;   
            ...
            tag.getGraphics().drawImage(   
                    src.getScaledInstance(newWidth, newHeight,   
                            Image.SCALE_SMOOTH), -left, -top, null);   
     ...
     * @param imgsrc 当前图片的路径
     * @param imgdist 生成图片的路径
     * @param widthdist 略缩图的宽度
     * @param heightdist 略缩图的高度
     */
	public static void reduceImgMWH(File srcfile, String imgdist, int widthdist,   
            int heightdist) {   
        try {   
            if (!srcfile.exists()) {   
                return;   
     ...
     * @param heightdist 略缩图的高度
     */
	public static void reduceImgWhilePNG(File srcfile, String imgdist, int widthdist,   
            int heightdist) {   
        try {   
            if (!srcfile.exists()) {   
                return;   
            ...
            BufferedImage tag = new BufferedImage(widthdist,   
                    heightdist, BufferedImage.TRANSLUCENT); 
...
//            tag.getGraphics().fillRect(0, 0, widthdist, heightdist);
            ...
            //---绘制图片
            graphics2d.drawImage(src.getScaledInstance(newWidth, newHeight,   
     ...
     * @param heightdist 略缩图的高度
     */
	public static void reduceImgWhileBk(File srcfile, String imgdist, int widthdist,   
            int heightdist) {   
        try {   
            if (!srcfile.exists()) {   
                return;   
...
/*            FileOutputStream out = new FileOutputStream(imgdist);   
     ...
     * @param heightdist
     */
    public static Boolean reduceImgSize(String imgsrc, String imgdist, int widthdist,   
            int heightdist,String reduceType){
     ...
     * 批量生成略缩图
     * @param imgSrc 源图片的路径
     * @param dirdist 生成略缩图目录的路径
     * @param whs 略缩图规则，800X600:400X300
     */
