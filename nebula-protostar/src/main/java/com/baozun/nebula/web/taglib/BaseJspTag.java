...
public abstract class BaseJspTag extends BaseTag{
	...
	protected String genPropertyString(){
		...
		if(loxiaType!=null){
			property.append(" loxiaType=\""+loxiaType+"\"");
		}
	...
	public String getLoxiaType() {
		return loxiaType;
	}

	public void setLoxiaType(String loxiaType) {
		this.loxiaType = loxiaType;
	}
