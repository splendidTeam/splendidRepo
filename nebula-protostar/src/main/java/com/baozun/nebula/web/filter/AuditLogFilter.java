...
public class AuditLogFilter extends OncePerRequestFilter{
        ...
        try{
            ...
            if (validateSuffix(getRequestURI(request))){
                ...
                if (LOGGER.isDebugEnabled()){
                    LOGGER.debug("[AUDIT_LOG_INFO] RequestInfoMapForLog:{}", JsonUtil.format(RequestUtil.getRequestInfoMapForLog(request)));
                }
    ...
    private boolean validateSuffix(String uri){
        ...
        if (uri.contains(".css") || uri.contains(".js") || uri.contains(".jpg") || uri.contains(".png") || uri.contains(".ico")
                        || uri.contains(".bmp") || uri.contains(".gif") || uri.contains(".tif") || uri.contains(".pcx") || uri.contains(
                                        ".tga"))
            return false;
        return true;
