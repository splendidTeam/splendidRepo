...
public class ImageUpLoadContorller extends BaseController {
	...
	@ResponseBody
	public String update(@RequestParam(value="CKEditorFuncNum")String CKEditorFuncNum,@RequestParam(value="upload",required=false) CommonsMultipartFile mFile, HttpServletRequest request){
		...
		String value="<script type='text/javascript'>window.parent.CKEDITOR.tools.callFunction("+CKEditorFuncNum+", '"+url+"', '');</script>";
