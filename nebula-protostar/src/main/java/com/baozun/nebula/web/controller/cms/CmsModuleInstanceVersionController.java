...
public class CmsModuleInstanceVersionController extends BaseController {
	...
	@ResponseBody
	public Pagination<CmsModuleInstanceVersion> findCmsModuleInstanceListByQueryMapWithPage(
		...
		return cmsModuleInstanceVersionManager
				.findCmsModuleInstanceVersionListByQueryMapWithPage(
	...
	public BackWarnEntity removeCmsModuleInstanceByIds(Long[] ids) {
		cmsModuleInstanceVersionManager.removeCmsModuleInstanceVersionPublishByIds(Arrays
				.asList(ids));
		return SUCCESS;
	}
	...
	@ResponseBody
	public BackWarnEntity saveModuleInstance(@ModelAttribute CmsModuleInstanceVersion cmsModuleInstanceVersion, 
	...
	@ResponseBody
	public Object publishModuleInstance(@RequestParam("versionId")Long versionId, 
