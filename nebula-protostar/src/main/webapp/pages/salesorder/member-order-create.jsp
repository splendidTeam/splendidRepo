...
<script type="text/javascript">
var promotionLogoMarkMap = <c:out value="${ promotionLogoMarkMap }" default="[]" escapeXml="false" />;
</script>	
...
<body id="orderInfoBody">
	...
	<div class="content-box width-percent100">
		...
		<form name="orderForm" action="/order/saveOrder.json" method="post"
			...
			<input type="hidden" name="isMemOrder" id="isMemOrder" value="true" />
			<input type="hidden" name="memberId" id="memberId" value="" />
			<input type="hidden" name="manualFlag" id="manualFlag" value="false"/>
			<div class="ui-title1">
				<img src="/images/wmi/blacks/32x32/cube.png">会员下单
			</div>
			<div class="ui-block">
				...
				<div id="second" style="display: block">
					...
					<div class="ui-block ">
						...
						<!-- 优惠开始 -->
						<div class="ui-block-title1" style="background: #fff; color: #000;">使用优惠券</div>
						
						<div class="ui-block-content border-grey">
						
							<div class="ui-block-line ">
								<label style="">优惠内容</label>
							</div>
							<div class="sbox-wrap">
								<div class="ui-block-line ">
									<div style="margin-left: 20px">输入您的礼品卡号或者优惠代码 :</div>
						
									<div style="margin-left: 20px">
										<input type="text" name="coupon" id="coupon"
											checkmaster="checkCoupon" onchange="updateFlag()" 　 placeholder="" />
						
										<input type="button" value="确定" title="确定" class="button"
											id="useCoupon" />
									</div>
	...
	<div id="sendactive" class="proto-dialog">
     <h5>赠品信息</h5>
     <table class="send-active-table" cellpadding="0" cellspacing="0">
     		<%--
     		<tr>
            	<td width="3%"><input type="checkbox" class="default-check" /></td>
                
                <td width="16%"><a href="#"><img src="images/example/532821-412_S1.png" class="border-grey" /></a></td>
                
                <td width="57%" class="ver-top left">
                	<p class="send-active-name"><a href="#">Levi's李维斯男士修身圆领时尚潮流短袖清爽T恤66874-0005</a></p>
                    
                    <span class="fLeft mr5 inline-block pt10">款式：</span>
                    <ul class="send-pro-type">
                        <li><a href="#" class="selected"><img src="images/example/product-small.jpg" /></a></li>
                        <li><a href="#"><img src="images/example/product-small.jpg" /></a></li>
                        <li><a href="#" class="disabled"><img src="images/example/product-small.png" /></a></li>
                    </ul>
                </td>
                
                <td width="24%"><select><option>请选择尺码</option></select></td>
            </tr>
             --%>
     </table>
     <div class="common-line center pt15 pb10">
          <a href="javascript:void(0);" id="cartSalesPropSure" class="button red-button">确定</a>
          <a href="javascript:void(0);" id="dialog_cencal" class="button grey-button cencal">取消</a>
     </div>
</div>
</body>
</html>
