...
<div class="tag-change-content">
            <div class="tag-change-in block">
                    <div class="ui-block">
                    <div class="ui-block-title1">修改邮件订阅</div>
  <form id="submitForm1" method="post" action="/email/subscribe/saveEmailSubscribe.htm">
  <input type='hidden' name='id' value='${emailSubscribe.id}' />
  <div class="ui-block-line">
    <label>邮箱</label>
    <input type="text" loxiaType="input" mandatory="true" value="${emailSubscribe.receiver}" name="receiver" id="code" placeholder="邮箱" class="ui-loxia-default ui-corner-all" aria-disabled="false">
    <a href="javascript:void(0);" data-val='CODE' class="func-button help" title="帮助">帮助</a>
  </div>
 <div class="ui-block-line">
    <label>模板code</label>
    <input type="text" loxiaType="input" mandatory="true" value="${emailSubscribe.templateCode}" name="templateCode" id="description" placeholder="模板code" class="ui-loxia-default ui-corner-all" aria-disabled="false">
  	<a href="javascript:void(0);" data-val='DESCRIPTION' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>数据(json)</label>
    <input type="text" loxiaType="input" mandatory="true" value="${emailSubscribe.data}" name="data" id="data" placeholder="数据(json)" class="ui-loxia-default ui-corner-all" aria-disabled="false" checkmaster="checkBeanName">
  	<a href="javascript:void(0);" data-val='BEAN_NAME' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>类型</label>
    <input type="text" loxiaType="input" mandatory="true" value="${emailSubscribe.type}" name="type" id="methodName" placeholder="类型" class="ui-loxia-default ui-corner-all" aria-disabled="false">
  	<a href="javascript:void(0);" data-val='METHOD_NAME' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
   <label>发送时间</label>
    <input loxiaType="date" mandatory="true" value="${emailSubscribe.date}" name="sendDate" class="ui-loxia-default ui-corner-all" aria-disabled="false"/>
    <a href="javascript:void(0);" data-val='METHOD_NAME' class="func-button help" title="帮助">帮助</a>
  </div>
