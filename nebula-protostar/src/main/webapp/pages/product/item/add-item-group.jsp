...
<script type="text/javascript" src="${base}/scripts/product/item/add-item-group.js"></script>
</head>
<body>

<div class="content-box width-percent100">
   <form id="itemForm" name="itemForm" action="/i18n/item/saveGroupItem.json" method="post">
			...
			<div id="second">
				...
				<div class="ui-block ">
					...
					<%--  <%@include file="/pages/product/item/add-item-price.jsp"%> --%>
				   	 <div class="mt10"></div>
				   	 <%-- bundle扩展信息 --%>
					 <%@include file="/pages/product/item/add-item-groupExtendedInfo.jsp"%>
				     <div class="mt10"></div>
					 <%-- SEO --%>
