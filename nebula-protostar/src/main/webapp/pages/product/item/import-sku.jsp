...
<script type="text/javascript" src="${base}/scripts/product/item/import-sku.js"></script>
...
<div class="content-box width-percent100">
    <div class="ui-title1"><img src="${base}/images/wmi/blacks/32x32/cube.png">商品上传</div>
	<div class="ui-block">
	

		<div class="">
		  <div class="ui-block-title1">商品信息上传</div>
		  <div class="ui-block-content border-grey">
			  <div class="ui-block-line ">
			        <label style="">选择行业</label>
					<select id="industry" name="industry" aria-disabled="false">
			            <c:forEach var="industry" items="${industryList}" varStatus="status">
							<c:if test="${industry.isShow && !industry.noCheck}">
							     <option value="${industry.id}">${industry.indu_name}</option>
							</c:if>
						 </c:forEach>
					</select>
					<input type="button" id="downLoadTmplOfSkuInfo" value="下载模版">
			  </div>
		 </div>
