...
<script type="text/javascript" src="${base}/scripts/product/property/add-property.js"></script>
...
<!-- sel industry -->
	...
	<div class="ui-block">
		...
		<div id="industrySelDiv" style="">
			<div class="ui-block" >
		    	<div class="ui-block-title1"><spring:message code="system.property.select"/></div>
			...
			<div class="button-line">
				<input type="button" value="<spring:message code="btn.confirm"/>" class="button orange comfirm" title="<spring:message code="btn.confirm"/>"/>
