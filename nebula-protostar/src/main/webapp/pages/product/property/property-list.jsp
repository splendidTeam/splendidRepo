...
<script type="text/javascript"
	src="${base}/scripts/product/property/product-propert.js"></script>
				...
				<table>
					<tr>
						<td><label><spring:message
									code="product.property.lable.name" /></label></td>
									
						<td><span id="searchkeytext"> <input type="text"
								loxiaType="input" mandatory="false" id="name"
								name="q_sl_name" placeholder="<spring:message code="product.property.lable.name" />"></input>
						</span></td>
