...
<div class="tag-change-content">
            <div class="tag-change-in block">
                    <div class="ui-block">
                    <div class="ui-block-title1">修改定时任务</div>
  <form id="submitForm1" method="post" action="/system/schedulerTask/saveSchedulerTask.htm">
  <input type='hidden' name='id' value='${schedulerTaskVo.id}' />
  <div class="ui-block-line">
    <label>任务编码</label>
    <input type="text" loxiaType="input" mandatory="true" value="${schedulerTaskVo.code}" name="code" id="code" placeholder="任务编码" class="ui-loxia-default ui-corner-all" aria-disabled="false">
    <a href="javascript:void(0);" data-val='CODE' class="func-button help" title="帮助">帮助</a>
  </div>
 <div class="ui-block-line">
    <label>任务描述</label>
    <input type="text" loxiaType="input" mandatory="true" value="${schedulerTaskVo.description}" name="description" id="description" placeholder="任务描述" class="ui-loxia-default ui-corner-all" aria-disabled="false">
  	<a href="javascript:void(0);" data-val='DESCRIPTION' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>Bean Name</label>
    <input type="text" loxiaType="input" mandatory="true" value="${schedulerTaskVo.beanName}" name="beanName" id="beanName" placeholder="对象名" class="ui-loxia-default ui-corner-all" aria-disabled="false" checkmaster="checkBeanName">
  	<a href="javascript:void(0);" data-val='BEAN_NAME' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>方法名</label>
    <input type="text" loxiaType="input" mandatory="true" value="${schedulerTaskVo.methodName}" name="methodName" id="methodName" placeholder="Bean Name" class="ui-loxia-default ui-corner-all" aria-disabled="false" checkmaster="checkMethodName">
  	<a href="javascript:void(0);" data-val='METHOD_NAME' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>时间表达式</label>
    <input type="text" loxiaType="input" mandatory="true" checkmaster="checkTimeExp" value="${schedulerTaskVo.timeExp}" name="timeExp" id="timeExp" placeholder="定时表达式" class="ui-loxia-default ui-corner-all" aria-disabled="false">
  	<a href="javascript:void(0);" data-val='TIME_EXP' class="func-button help" title="帮助">帮助</a>
  </div>
  <div class="ui-block-line">
    <label>状态</label>
    <opt:select id="lifecycle" name="lifecycle" loxiaType="select" defaultValue="${schedulerTaskVo.lifecycle}" expression="chooseOption.IS_AVAILABLE"/>
  </div>
