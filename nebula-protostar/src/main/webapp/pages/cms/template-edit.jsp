...
<div class="content-box width-percent100">
	<div class="ui-title1"><img src="${base}/images/wmi/blacks/32x32/cube.png">编辑模板
    ...
    <div class="ui-block">
    	...
    	<script type="text/javascript" src="${base}/scripts/cms/newpage/edit-template-product.js" ></script>
		<script type="text/javascript" src="${base}/scripts/cms/newpage/edit-template.js" ></script>
		<iframe src="${base}/cms/findTemplateByTemplateId.htm?templateId=${templateId}" width="100%" class="web-update" frameborder="0"></iframe>
    </div>
    <div class="button-line">
         <input type="button" value="<spring:message code="btn.save" />" title="<spring:message code="btn.save" />" class="button orange save" />
       	 <input type="button" value="预览" class="button orange preview" title="预览"/>
