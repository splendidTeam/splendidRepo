...
<script type="text/javascript" src="${base}/scripts/cms/newpage/page-instance-version-add.js"></script>
...
<div class="content-box width-percent100">
	...
	<form id="pageInstanceForm" name="pageInstanceForm" action="${base}/page/saveCmsPageInstanceVersion.json" method="post">
		...
		<input type="hidden" name="instanceId" id="pageId" value="${instanceId}" />
		<input type="hidden" name="Id" id="versionId" value="${cmsPageInstanceVersion.id}" />
		<div class="ui-block">
			<div class="ui-block-content ui-block-content-lb">
				<table class="width: 100%;">
					<tr>
						<td><label>实例版本名称</label></td>
						<td><input type="text" loxiaType="input" mandatory="true" id="name" name="name" placeholder="实例版本名称" value="${ cmsPageInstanceVersion.name }"/></td>
					</tr>
				</table>
			</div>
		</div>
    ...
    <div class="ui-block">
		...
		<iframe src="${base}/page/findTemplatePageVersionAreaByTemplateId.htm?templateId=${ cmsPageTemplate.id }&pageId=${instanceId}&versionId=${ cmsPageInstanceVersion.id }&isEdit=true" width="100%" class="web-update" frameborder="0"></iframe>
    </div>
...
<div class="proto-dialog cms-publish-dialog" wid="">
	...
	<div class="ui-block">
        ...
        <div class="ui-block-line mt5"  >
			...
			<input loxiaType="date" class="starttime" value="<fmt:formatDate value="${cmsPageInstanceVersion.startTime}" pattern="yyyy-MM-dd HH:mm:ss" />" showtime="true"/>
		  </div>
		  <div class="ui-block-line mt5" >
			<label>结束时间</label>
			<input loxiaType="date" class="endtime" value="<fmt:formatDate value="${cmsPageInstanceVersion.endTime}" pattern="yyyy-MM-dd HH:mm:ss" />" showtime="true" />
		  </div>
	  </div>
     </div>
     <div class="proto-dialog-button-line">
