...
<script type="text/javascript" src="${base}/scripts/cms/module/module-instance-version-add.js"></script>
...
<div class="content-box width-percent100">
	<div class="ui-title1"><img src="${base}/images/wmi/blacks/32x32/cube.png">新建模块实例版本
	...
	<form id="pageInstanceForm" name="pageInstanceForm" action="${base}/module/saveModuleInstanceVersion.json" method="post">
		<input type="hidden" name="templateId" id="templateId" value="${cmi.templateId}" />
		<input type="hidden" name="html" id="html" value="" />
		<input type="hidden" name="instanceId" id="moduleId" value="${cmi.id}" />
		<input type="hidden" name="Id" id="versionId" value="${cmiv.id}" />
		<div class="ui-block">
			<div class="ui-block-content ui-block-content-lb">
				<table>
					<tr>
						<td><label>模块版本名称</label></td>
						<td><input type="text" loxiaType="input" mandatory="true" id="name" name="name" placeholder="模块版本名称" value="${cmiv.name}" checkmaster="checkPageName"/></td>
					</tr>
				</table>
			</div>
		</div>
    ...
    <div class="ui-block">
		...
		<iframe src="${base}/module/findTemplateModuleVersionAreaByTemplateId.htm?templateId=${cmi.templateId}&moduleId=${cmi.id}&versionId=${cmiv.id}&isEdit=true" width="100%" class="web-update" frameborder="0"></iframe>
    </div>
...
<div class="proto-dialog cms-publish-dialog" wid="">
	...
	<div class="ui-block">
        ...
        <div class="ui-block-line mt5"  >
			...
			<input loxiaType="date" class="starttime" value="<fmt:formatDate value="${cmiv.startTime}" pattern="yyyy-MM-dd HH:mm:ss" />" showtime="true"/>
		  </div>
		  <div class="ui-block-line mt5" >
			<label>结束时间</label>
			<input loxiaType="date" class="endtime" value="<fmt:formatDate value="${cmiv.endTime}" pattern="yyyy-MM-dd HH:mm:ss" />" showtime="true" />
		  </div>
	  </div>
     </div>
     <div class="proto-dialog-button-line">
