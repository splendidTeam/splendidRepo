...
$.fn.tip.defaults={
  ...
  border: "#FEFFD4 solid1px",          //边框样式
  contentcolor:"#FFFFFE",                //正文色
  font: "12pxverdana,arial,sans-serif" //字体样式
 };
...
var tipdiv=null;
 ...
 function init(options){
  ...
  if(tipobj.length==0){
   tipobj=[];
   tipobj.push("<divid=\"jq_bbf_tipdiv\"style=\"display:none;position:absolute;z-index:1000;max-width:");
   ...
   tipobj.push(";text-align:left;padding:3px;\"><pstyle=\"margin:0;padding:0;color:");
