...
public class LogisticsManagerTest{
    ...
    private ShippingFeeConfigCommand getShippingFeeConfigCommand(int basePrice,int FirstPartPrice,Integer FirstPartUnit,int SubsequentPartPrice,Integer SubsequentPartUnit,Long DistributionModeId,Long AreaId){
        ShippingFeeConfigCommand cmd = new ShippingFeeConfigCommand();
