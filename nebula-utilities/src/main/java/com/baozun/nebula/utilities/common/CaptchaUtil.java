 ...
 * @author Justin Hu
 * 
 * @deprecated 不建议使用这种很古老的验证码, 可以使用 botdetect 或者 touclick 可以咨询 feilong
 * 
 */
@Deprecated
public class CaptchaUtil{
    ...
    private static String[] nums = new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9" };

    private static String[] letters = new String[] { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "m", "n", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y" };
    ...
    static{
        ...
        try{
            in = ResourceUtil.getResourceAsStream("timesbd.ttf", CaptchaUtil.class);
