...
public class AlipayThirdPartyMember extends AbstractThirdPartyMemberAdaptor implements ThirdPartyMemberAdaptor {
	...
	public ThirdPartyMember returnMember(HttpServletRequest request) {
		...
		// 如果是alipay联合登录成功
			...
			logger.debug("alipayEmail:" + alipayEmail + ",gmt_decay:" + gmt_decay + ",notify_id:" + notify_id + ",real_name:" + real_name + ",tokenStr:" + tokenStr + ",user_id:" + user_id + ",userGrade:" + userGrade + ",userGradeType:" + userGradeType + ",sign:" + sign);
