...
public class RequestToCommand{
    ...
    public PaymentServiceReturnCommand alipaySynRequestToCommand(HttpServletRequest request){
        return buildPaymentServiceReturnCommand(request, getAlipaySyn());
    }

    public PaymentServiceReturnCommand alipayAsyRequestToCommand(HttpServletRequest request){
        return buildPaymentServiceReturnCommand(request, getAlipayAsy());
    }
    ...
    private PaymentServiceReturnCommand buildPaymentServiceReturnCommand(HttpServletRequest request,Map<String, String> alipaySyn){
        ...
        setParamValue(alipaySyn, result, paymentServiceReturnCommand);
        paymentServiceReturnCommand.setAllMessage(JSONObject.fromObject(result).toString());
        return paymentServiceReturnCommand;
    }

    public PaymentServiceReturnForMobileCommand alipaySynRequestToCommandForMobile(HttpServletRequest request,Map<String, String> otherValue){
     ...
     * @return
     * @deprecated 没有被调用 <br>
     *             add javadoc by jinxin (2017年6月1日 下午3:33:40)
     */
    @Deprecated
    public PaymentServiceReturnCommand unionRequestToCommand(HttpServletRequest request){
        return buildPaymentServiceReturnCommand(request, getUnion());
    }

    //----------------------------------------------------------------------------------------------------------

    private void setParamValue(Map<String, String> keyMap,Map<String, String> valueMap,PaymentServiceReturnCommand paymentServiceReturnCommand){
